<template>
    <div>
        <el-container style="height: 700px; border: 1px solid #eee">
            <el-header style="font-size:30px;height:45px; background-color: rgb(238, 241, 246)">tlias 智能学习辅助系统</el-header>
            <el-container>
                <el-aside style="width: 220px; height: 655px; border: 1px solid #eee">
...
export default {
    ...
    mounted() {
        //发送异步请求，获取数据
        axios.get("https://mock.apifox.cn/m1/3128855-0-default/emp/list").then((result) => { this.tableData = result.data.data; });
    }
}
</script>
